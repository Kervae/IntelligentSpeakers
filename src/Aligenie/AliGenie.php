 ...
 */
namespace zelang\IntelligentSpeakers\Aligenie;

use zelang\IntelligentSpeakers\Speakers;
use zelang\IntelligentSpeakers\Aligenie\Request as AliGenieRequest;
use Exception;
